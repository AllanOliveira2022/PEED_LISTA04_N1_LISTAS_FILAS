...
print("Elemento do fim: ", lista.mostrar_fim())
print("Valor do inicio: ", lista.mostrar_inicio())
print("Removendo fim: ",lista.remover_fim())
print("Removendo inicio: ", lista.remover_inicio())
print("Lista")
print(lista.mostrar_lista())
